...
GenericAuthSetting = TypedDict(
    'GenericAuthSetting', {'type': str, 'in': str, 'key': str, 'value': str}
)
...
APIKeyAuthSetting = TypedDict(
    'APIKeyAuthSetting',
    {'type': Literal['api_key'], 'in': str, 'key': str, 'value': str | None},
)
...
class AuthSettings(TypedDict, total=False):
    AccessTokenAuth: BearerFormatAuthSetting
...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor"""
        self._base_path = (
            'https://api.onecta.daikineurope.com/v1' if host is None else host
        )
        """Default Base url
        """
        self.server_index = (
    ...
    def get_host_settings(self) -> list[HostSetting]:
        ...
        return [
            {
                'url': 'https://api.onecta.daikineurope.com/v1',
                'description': 'No description provided',
            },
            {
                'url': 'https://api.onecta.daikineurope.com/mock/v1',
                'description': 'No description provided',
            },
        ]
