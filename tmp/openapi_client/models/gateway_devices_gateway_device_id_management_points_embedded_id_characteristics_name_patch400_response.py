...
class GatewayDevicesGatewayDeviceIdManagementPointsEmbeddedIdCharacteristicsNamePatch400Response(
    BaseModel
):
    ...
    def code_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(
            ['READ_ONLY_CHARACTERISTIC', 'INVALID_CHARACTERISTIC_VALUE']
        ):
            raise ValueError(
                "must be one of enum values ('READ_ONLY_CHARACTERISTIC', 'INVALID_CHARACTERISTIC_VALUE')"
            )
        return value
