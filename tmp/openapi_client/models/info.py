...
class Info(BaseModel):
    ...
    app: StrictStr | None = Field(
        default=None, description='The service name'
    )
    versions: InfoVersions | None = None
    __properties: ClassVar[list[str]] = ['app', 'versions']
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                'app': obj.get('app'),
                'versions': InfoVersions.from_dict(obj['versions'])
