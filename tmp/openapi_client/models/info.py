...
class Info(BaseModel):
    ...
    Info
    """ # noqa: E501
    app: Optional[StrictStr] = Field(default=None, description="The service name")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "app": obj.get("app"),
            "versions": InfoVersions.from_dict(obj["versions"]) if obj.get("versions") is not None else None
        })
        return _obj
