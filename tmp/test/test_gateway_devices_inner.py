...
class TestGatewayDevicesInner(unittest.TestCase):
    """GatewayDevicesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GatewayDevicesInner:
        """Test GatewayDevicesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GatewayDevicesInner`
        """
        model = GatewayDevicesInner()
        if include_optional:
            return GatewayDevicesInner(
    ...
    def testGatewayDevicesInner(self):
        """Test GatewayDevicesInner"""
