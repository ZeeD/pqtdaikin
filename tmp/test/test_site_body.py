...
class TestSiteBody(unittest.TestCase):
    """SiteBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SiteBody:
        """Test SiteBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SiteBody`
        """
        model = SiteBody()
        if include_optional:
            return SiteBody(
