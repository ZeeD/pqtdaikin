...
class TestManagementPoint(unittest.TestCase):
    """ManagementPoint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagementPoint:
        """Test ManagementPoint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagementPoint`
        """
        model = ManagementPoint()
        if include_optional:
